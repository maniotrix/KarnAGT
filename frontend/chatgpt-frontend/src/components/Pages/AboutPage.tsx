    ...
    <div className="min-h-screen bg-gray-50 flex flex-col overflow-y-auto" style={{ height: 'auto', minHeight: '100vh' }}>
      ...
      <main className="flex-1 px-2 sm:px-0">
          ...
          <div className="text-center">
            <div className="flex flex-col items-center mb-6">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 text-center">
                About <span className="text-blue-600">KarnAGT</span>
              </h1>
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-8 sm:p-12">
              <div className="flex flex-col lg:flex-row items-center gap-8">
                <div className="flex-1">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">Why Agentic AI?</h3>
        ...
        <div className="bg-white py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Our Technology</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Advanced Reasoning</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Real-time Knowledge</h3>
                <p className="text-gray-600">
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Privacy-First Architecture</h3>
                <p className="text-gray-600">
