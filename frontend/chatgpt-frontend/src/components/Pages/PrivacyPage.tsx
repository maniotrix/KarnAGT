    ...
    <div className="min-h-screen bg-gray-50 flex flex-col overflow-y-auto" style={{ height: 'auto', minHeight: '100vh' }}>
      ...
      <main className="flex-1 px-2 sm:px-0">
        ...
        <div className="bg-white border-b border-gray-200 sticky top-0 z-10">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex flex-wrap gap-4 text-sm">
              <a href="#data-collection" className="text-blue-600 hover:text-blue-800 transition-colors">Data Collection</a>
              <a href="#how-we-use" className="text-blue-600 hover:text-blue-800 transition-colors">How We Use Data</a>
              <a href="#data-sharing" className="text-blue-600 hover:text-blue-800 transition-colors">Data Sharing</a>
              <a href="#your-rights" className="text-blue-600 hover:text-blue-800 transition-colors">Your Rights</a>
              <a href="#security" className="text-blue-600 hover:text-blue-800 transition-colors">Security</a>
              <a href="#contact" className="text-blue-600 hover:text-blue-800 transition-colors">Contact Us</a>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 sm:p-12 space-y-12">
            
            {/* Introduction */}
            <div className="prose prose-gray max-w-none">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
                <div className="flex items-start">
                  <Eye className="h-6 w-6 text-blue-600 mt-1 mr-3 flex-shrink-0" />
                  <div>
            ...
            <section id="data-collection">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="font-semibold text-gray-900 mb-3">Information We Don't Collect</h3>
            ...
            <section id="how-we-use">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-gray-50 p-6 rounded-lg">
                    <h3 className="font-semibold text-gray-900 mb-3">Core Service Operations</h3>
            ...
            <section id="data-sharing">
              ...
              <div className="space-y-4 text-gray-700">
                <div className="bg-red-50 border border-red-200 p-6 rounded-lg">
                  <h3 className="font-semibold text-red-900 mb-3">We Never Sell Your Data</h3>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-green-50 p-6 rounded-lg">
                    <h3 className="font-semibold text-green-900 mb-3">Access & Portability</h3>
                  ...
                  <div className="bg-blue-50 p-6 rounded-lg">
                    <h3 className="font-semibold text-blue-900 mb-3">Control & Correction</h3>
                  ...
                  <div className="bg-purple-50 p-6 rounded-lg">
                    <h3 className="font-semibold text-purple-900 mb-3">Deletion & Restriction</h3>
                  ...
                  <div className="bg-orange-50 p-6 rounded-lg">
                    <h3 className="font-semibold text-orange-900 mb-3">Objection & Complaint</h3>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="bg-blue-50 p-6 rounded-lg">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <h4 className="font-semibold text-blue-900">Privacy Officer</h4>
                      <p className="text-blue-800">privacy@karnagt.com</p>
                    </div>
                    <div>
