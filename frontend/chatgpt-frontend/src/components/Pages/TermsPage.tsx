      ...
      <main className="flex-1 px-2 sm:px-0">
        ...
        <div className="bg-white border-b border-gray-200 sticky top-0 z-10">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex flex-wrap gap-4 text-sm">
              <a href="#service-agreement" className="text-blue-600 hover:text-blue-800 transition-colors">Service Agreement</a>
              <a href="#user-responsibilities" className="text-blue-600 hover:text-blue-800 transition-colors">User Responsibilities</a>
              <a href="#privacy-data" className="text-blue-600 hover:text-blue-800 transition-colors">Privacy & Data</a>
              <a href="#intellectual-property" className="text-blue-600 hover:text-blue-800 transition-colors">Intellectual Property</a>
              <a href="#limitations" className="text-blue-600 hover:text-blue-800 transition-colors">Limitations</a>
              <a href="#termination" className="text-blue-600 hover:text-blue-800 transition-colors">Termination</a>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="prose prose-gray max-w-none">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-blue-900 mb-2">Agreement Overview</h3>
          ...
          <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-blue-900 mb-3">By using KarnAGT, you acknowledge that:</h3>
