    ...
    def build(self, env: str) -> None:
        ...
        if current_context != 'default':
            ...
            if ('ssh://' in current_context or 
                ...
                print(f"{Colors.GREEN}   python frontend/app-frontend/frontend_docker_manager.py build --env={env}{Colors.END}")
                print()
        ...
        if build:
            ...
            if current_context != 'default':
                ...
                if ('ssh://' in current_context or 
                    ...
                    print(f"{Colors.CYAN}💡 Use: python frontend/app-frontend/frontend_docker_manager.py build --env={env} (on EC2 directly){Colors.END}")
